...
<details><summary> Click to see default `app_config.h` </summary>
...
You should be able to see `CPID` and `Environment` fields in the top part of the screen ([additional information](#iotconnect_cpid-and-iotconnect_env)):
